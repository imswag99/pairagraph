...
- No error-tracking/monitoring service — structured logging (§1) means logs are at least parseable, but there's still no alerting; a bug in production is only ever found via a user report or manually reading logs.
